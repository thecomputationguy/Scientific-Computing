% The main() function solves the Time-dependent Heat Equation using both the Implicit & Explicit Methods
% The implicit and explicit solvers are called in appropriate places
%To visualize results, graphs are plotted for each spatial and temporal
%resolutions and unstable cases are marked
